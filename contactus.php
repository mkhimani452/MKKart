...
<div class="header-1">
    ...
    <a href="index.php" class="logo" > <img src="website/all/MKKartLogo.png" alt="Logo image" class="hidden-xs">  </a>
...
if(isset($_POST['submit'])){
  ...
  $senderMessage = $_POST['message']; // Fixed variable name

  $receiverEmail = "mkhimani452@rku.ac.in";
  mail($receiverEmail, $senderSubject, $senderMessage, "From: $senderEmail");
  
  // Customer mail
  $subject = "Welcome to our website";
  $msg = "We will get back to you soon, thanks for sending an email.";
  $from = "mkhimani452@rku.ac.in";
  mail($senderEmail, $subject, $msg, "From: $from");
